...
export default function Article() {
    ...
    return (
        <section ref={ref} className="">
            <div
                className="flex flex-col lg:flex-row gap-20 h-full lg:h-screen px-10 md:px-20 md:py-10 mt-10 items-center">
                <article
                    style={{
                ...
                <div
                    ...
                    className="hidden lg:block w-full md:w-1/2 h-full rounded-3xl overflow-hidden">
                    <img src={landslide} className=" object-cover object-right w-full h-full " alt="" />
                </div>
            </div>
